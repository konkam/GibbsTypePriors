...
@test_nowarn GibbsTypePriors.Pkn_approx(90, 100,  1.2, 0.6)
@test_nowarn GibbsTypePriors.Pkn_approx(100, 100,  1.2, 0.6)
@test GibbsTypePriors.Pkn_approx(100, 100,  1.2, 0.6, 100, -1) == -1
