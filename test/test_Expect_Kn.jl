...
@testset "Expectation DP" begin
    ...
    @test_nowarn GibbsTypePriors.expected_number_of_clusters_Dirichlet_Multinomial(100, 100, 0.1)
        @testset "Comparison between methods" begin
        @test Float64(GibbsTypePriors.expected_number_of_clusters_DPM(100, 100, 1.0)) ≈ Float64(GibbsTypePriors.expected_number_of_clusters_Dirichlet_Multinomial(100, 100, 1.0))
...
@testset "Expectation PY" begin
    ...
    @test_nowarn GibbsTypePriors.expected_number_of_clusters_PYM(50,50,  0.1, 0.5)
    @test_nowarn GibbsTypePriors.expected_number_of_clusters_PYM(50,50,  0.1, 0.5, 50)
    @testset "Comparison between methods" begin
        @test Float64(GibbsTypePriors.expected_number_of_clusters_PYM(100,100,  60., 0.1))<  Float64(GibbsTypePriors.expected_number_of_clusters_PD_direct(100, 60., 0.1))
...
@testset "Expectation NGG" begin
    @test_nowarn GibbsTypePriors.expected_number_of_clusters_NGG(50, 60., 0.1, 50)
    @test_nowarn GibbsTypePriors.expected_number_of_clusters_NGG(50, 60., 0.1)
    @test_nowarn GibbsTypePriors.expected_number_of_clusters_NGGM(50, 50, 60., 0.1,10)
    @testset "Comparison between methods" begin
        @test Float64(GibbsTypePriors.expected_number_of_clusters_NGGM(30, 50, 60., 0.1))< Float64(GibbsTypePriors.expected_number_of_clusters_NGG(30, 60., 0.1))
        @test Float64(GibbsTypePriors.expected_number_of_clusters_NGG(20, 60., 0.1, 10))< Float64(GibbsTypePriors.expected_number_of_clusters_NGG(20, 60., 0.1))
        @test Float64(GibbsTypePriors.E_PY(100, 60., 0.1)) ≈  Float64(GibbsTypePriors.expected_number_of_clusters_PD_direct(100, 60., 0.1))
        @test Float64(GibbsTypePriors.expected_number_of_cluster_2PD(10, 0., 0.4)) == Float64(GibbsTypePriors.E_PY(10, 0., 0.4))
        @test Float64(GibbsTypePriors.E_PY(100, 6., 0.9)) ≈  Float64(GibbsTypePriors.expected_number_of_clusters_PD_direct(100, 6., 0.9))
        @test Float64(GibbsTypePriors.E_2PD(100, 6., 0.9, 50)) < Float64(GibbsTypePriors.E_PY(100, 6.0, 0.9))
...
@testset "Variance for Gibbs-type priors" begin
    @testset "Variance DP" begin
        ...
        @test_nowarn GibbsTypePriors.variance_number_of_clusters_DPM(100, 100, 0.1)
        @test_nowarn GibbsTypePriors.variance_number_of_clusters_Dirichlet(100, 0.1)
        @testset "Comparison" begin
            @test Float64(GibbsTypePriors.variance_number_of_clusters_DPM(100, 100, 0.1)) < Float64(GibbsTypePriors.V_Dirichlet(100, 0.1))
    ...
    @testset "Variance PY" begin
        ...
        @test_nowarn GibbsTypePriors.variance_number_of_clusters_PD(20, 5., 0.9)
        @test_nowarn GibbsTypePriors.variance_number_of_clusters_PYM(20,50,  5., 0.9)
        @testset "Comparison between methods" begin
            @test Float64(GibbsTypePriors.variance_number_of_clusters_PD(100, 0.5, 0.5)) ≈ Float64(GibbsTypePriors.V_PY(100, 0.5, 0.5))
            @test Float64(GibbsTypePriors.variance_number_of_clusters_PD(100, 0.5, 0.5)) ≈ Float64(GibbsTypePriors.variance_number_of_clusters_PD_direct(100, 0.5, 0.5))
        end
    end
    @testset "Variance NGG" begin
        @test_nowarn GibbsTypePriors.variance_number_of_clusters_NGG(50, 60., 0.1)
        @test_nowarn GibbsTypePriors.variance_number_of_clusters_NGG(10, 6., 0.8)
        @test_nowarn GibbsTypePriors.variance_number_of_clusters_NGGM(10, 10, 6., 0.8)
    end
end
